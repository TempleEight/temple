...
import "github.com/squat/and/dab/booking/dao"
...
type Hook struct {
	...
	beforeUpdateHooks []*func(env *env, input *dao.UpdateBookingInput) *HookError
...
func (h *Hook) BeforeRead(hook func(env *env, input *dao.ReadBookingInput) *HookError) {
...
func (h *Hook) BeforeUpdate(hook func(env *env, input *dao.UpdateBookingInput) *HookError) {
...
func (h *Hook) AfterCreate(hook func(env *env, booking *dao.Booking) *HookError) {
