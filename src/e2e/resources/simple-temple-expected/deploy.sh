...
# DB init scripts
kubectl create configmap simple-temple-test-user-db-config --from-file "$BASEDIR/simple-temple-test-user-db/init.sql" -o=yaml
kubectl create configmap booking-db-config --from-file "$BASEDIR/booking-db/init.sql" -o=yaml
kubectl create configmap simple-temple-test-group-db-config --from-file "$BASEDIR/simple-temple-test-group-db/init.sql" -o=yaml
