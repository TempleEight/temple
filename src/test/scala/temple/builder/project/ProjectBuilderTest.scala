...
class ProjectBuilderTest extends FlatSpec with Matchers {
  ...
  it should "correctly create a simple project using postgres as the default" in {
    ...
    val expected = Map(
        ...
        File("templeuser", "hook.go")                              -> ProjectBuilderTestData.simpleTemplefileHookGoFile,
  ...
  it should "correctly create a complex service with nested struct" in {
    ...
    project.files shouldBe Map(
      ...
      File("auth-db", "init.sql")                                 -> ProjectBuilderTestData.complexTemplefilePostgresAuthOutput,
      ...
      File("complexuser", "hook.go")                              -> ProjectBuilderTestData.complexTemplefileHookGoFile,
      ...
      File("kube/auth", "deployment.yaml")                        -> ProjectBuilderTestData.complexTemplefileAuthKubeDeployment,
      File("kube/auth", "db-deployment.yaml")                     -> ProjectBuilderTestData.complexTemplefileAuthKubeDbDeployment,
      File("kube/auth", "service.yaml")                           -> ProjectBuilderTestData.complexTemplefileAuthKubeService,
      File("kube/auth", "db-service.yaml")                        -> ProjectBuilderTestData.complexTemplefileAuthKubeDbService,
      File("kube/auth", "db-storage.yaml")                        -> ProjectBuilderTestData.complexTemplefileAuthKubeDbStorage,
      ...
      File("grafana/provisioning/dashboards", "auth.json")        -> ProjectBuilderTestData.complexTemplefileAuthGrafanaDashboard,
